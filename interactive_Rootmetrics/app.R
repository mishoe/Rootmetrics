...
ui <- fluidPage(
  ...
  sidebarLayout(
    sidebarPanel(tabsetPanel(
      ...
      tabPanel('Comparisons',selectInput("comp1",
...
server <- function(input, output) {
  ...
  #data file for first portion comparison plot
  filedata2 <- reactive({
    if (is.null(input$stars)) {
      # User has not uploaded a file yet
      return(NULL)
    }
    if(input$comp1=='RootScore 1h-2h'){read.csv(paste('../Data/1H/',input$data_type,'_','score_rank','_1H2017.csv',sep = ''))}
    else if(input$comp1=='RootStar 1h-2h'){read.csv(paste('../Data/1H/',input$data_type,'_','star_rank','_1H2017.csv',sep = ''))}
    else if(input$comp1=='Rootscore 1h - RootStar 2h'){read.csv(paste('../Data/1H/',input$data_type,'_','score_rank','_1H2017.csv',sep = ''))}
    else if(input$comp1=='Rootscore 1h - RootStar 1h'){read.csv(paste('../Data/1H/',input$data_type,'_','score_rank','_1H2017.csv',sep = ''))}
    else if(input$comp1=='Rootscore 2h - RootStar 2h'){read.csv(paste('../Data/2H/',input$data_type,'_','score_rank','_1H2017.csv',sep = ''))}
    
    
    })
  
  #data file for second portion comparison plot
  filedata3 <- reactive({
    if (is.null(input$stars)) {
      # User has not uploaded a file yet
      return(NULL)
    }
    if(input$comp1=='RootScore 1h-2h'){read.csv(paste('../Data/2H/',input$data_type,'_','score_rank','_1H2017.csv',sep = ''))}
    else if(input$comp1=='RootStar 1h-2h'){read.csv(paste('../Data/2H/',input$data_type,'_','star_rank','_1H2017.csv',sep = ''))}
    else if(input$comp1=='Rootscore 1h - RootStar 2h'){read.csv(paste('../Data/2H/',input$data_type,'_','star_rank','_1H2017.csv',sep = ''))}
    else if(input$comp1=='Rootscore 1h - RootStar 1h'){read.csv(paste('../Data/1H/',input$data_type,'_','star_rank','_1H2017.csv',sep = ''))}
    else if(input$comp1=='Rootscore 2h - RootStar 2h'){read.csv(paste('../Data/2H/',input$data_type,'_','star_rank','_1H2017.csv',sep = ''))}
